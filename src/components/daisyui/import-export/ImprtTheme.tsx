...
import { importThemes } from "./utils.js";
import { setThemeValuesToCssVariables } from "../utils/load-themes.js";
...
export function ImportTheme({  }: ImportThemeProps) {
  ...
  const updateWholeTheme = useDaisyUIThemeStore((state) => state.setAllThemes);
  return (
      ...
      <button
        onClick={() => {
          ...
          if (imported_theme) {
            ...
            setThemeValuesToCssVariables(imported_theme);
          }
        }}
